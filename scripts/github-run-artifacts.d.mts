...
export function selectPassingManagedEvidence(
  artifacts: RunArtifact[],
  validateArtifact: (artifact: RunArtifact) => Promise<{ remoteDate: string } | null>,
): Promise<{ mode: "create" } | { mode: "reuse"; artifactId: string; name: string; remoteDate: string }>;
export function selectExactRunArtifact(
  artifacts: RunArtifact[],
  name: string,
  options?: { allowCreate?: boolean },
): RunArtifactSelection;
