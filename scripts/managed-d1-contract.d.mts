export const MANAGED_SCENARIO_IDS: readonly [
...
export function formatManagedResourceName(options: {
  now?: Date;
  runId: string;
  attempt: string;
  randomHex?: string;
...
export function initialResourceState(options: { name: string; candidateSha256: string; createdAt?: string }): {
  grammarVersion: 1;
  candidateSha256: string;
  createdAt: string;
  database: { status: "not-created"; name: string };
  worker: { status: "not-created"; name: string };
};
export function stableJson(value: unknown): string;
export function writePrivateJson(path: string, value: unknown): Promise<void>;
export function validateManagedD1Evidence(options: {
  evidence?: unknown;
  path?: string;
  candidateSha256?: string;
  sourceCommit?: string;
  ...
  config?: import("./compatibility-config.mjs").CompatibilityConfig;
  root?: string;
